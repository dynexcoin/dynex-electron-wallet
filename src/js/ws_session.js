...
const DEFAULT_TITLE = 'Dynex Electron Wallet';
const SESSION_KEY = 'dynexWallet$essionK3Y';
...
var WalletShellSession = function(){
    ...
    this.sessDefault = {
        ...
        nodePath: settings.get('node_bin', 'DNX-node'),
        servicePath: settings.get('service_bin', 'DNX-service'),
		wrappedAddr: settings.get('wrapped_addr'),
		qnodeSubgrp: settings.get('qnode_subgrp'),
        configUpdated: false,
